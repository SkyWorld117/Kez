...
void download_source(const YAML::Node pkg_config, const YAML::Node release,
    ...
    if (source_type == "tarball") {
        ...
        instructions.push_back("wget --quiet --show-progress --no-check-certificate "
                               ...
                               ext + " " + url);
        instructions.push_back("bash $FROMAGER_HOME/tools/fgr_unpack.sh source" +
                               ext + " source");
        ...
        instructions.push_back("bash $FROMAGER_HOME/tools/fgr_shallow_clone.sh " + git_url +
                               " " + git_tag + " source");
        instructions.push_back("cd source");
        ...
        instructions.push_back(
            "bash $FROMAGER_HOME/tools/fgr_unpack.sh source.zip source");
