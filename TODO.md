# Core
| <div style="width:80px">Status</div> | Task Description | <div style="width:70px">Developer</div> |
|------------------|--------|-----------|
...
| Not Started | Fix CMake multithreading. (Use `cmake --build . --parallel` instead of `make -j`). | - |
